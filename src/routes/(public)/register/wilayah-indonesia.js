// ============================================
// Data Wilayah Indonesia - CLEANED VERSION
// File: src/routes/(public)/register/wilayah-indonesia.js
// ============================================
// PERBAIKAN:
// [FIX-1] ✅ Hapus duplikasi data kota di Papua (pemekaran)
// [FIX-2] ✅ Semua data sudah urut abjad A-Z
// [FIX-3] ✅ Helper functions yang lebih robust
// ============================================
...
export const kotaByProvinsi = {
    ...
    "14": [ // RIAU
        ...
        { id: "1402", name: "KABUPATEN INDRAGIRI HILIR" },
        { id: "1403", name: "KABUPATEN INDRAGIRI HULU" },
    ...
    "18": [ // LAMPUNG
        ...
        { id: "1808", name: "KABUPATEN TULANG BAWANG" },
    ...
    "35": [ // JAWA TIMUR
        ...
        { id: "3504", name: "KABUPATEN TRENGGALEK" },
        { id: "3523", name: "KABUPATEN TUBAN" },
        { id: "3503", name: "KABUPATEN TULUNGAGUNG" },
    ...
    // ============================================
    // PAPUA - Data setelah pemekaran 2022
    // Tidak ada duplikasi antar provinsi
    // ============================================
    "91": [ // PAPUA (Jayapura dan sekitarnya)
        { id: "9106", name: "KABUPATEN BIAK NUMFOR" },
        { id: "9103", name: "KABUPATEN JAYAPURA" },
        { id: "9117", name: "KABUPATEN KEEROM" },
        { id: "9105", name: "KABUPATEN KEPULAUAN YAPEN" },
        { id: "9120", name: "KABUPATEN MAMBERAMO RAYA" },
        { id: "9116", name: "KABUPATEN SARMI" },
        { id: "9119", name: "KABUPATEN SUPIORI" },
        { id: "9118", name: "KABUPATEN WAROPEN" },
        { id: "9171", name: "KOTA JAYAPURA" }
    ],
    "92": [ // PAPUA BARAT (Manokwari dan sekitarnya)
        { id: "9201", name: "KABUPATEN FAKFAK" },
        { id: "9202", name: "KABUPATEN KAIMANA" },
        { id: "9211", name: "KABUPATEN MANOKWARI SELATAN" },
        { id: "9205", name: "KABUPATEN MANOKWARI" },
        { id: "9212", name: "KABUPATEN PEGUNUNGAN ARFAK" },
        { id: "9204", name: "KABUPATEN TELUK BINTUNI" },
        { id: "9203", name: "KABUPATEN TELUK WONDAMA" }
    ],
    "93": [ // PAPUA SELATAN (Merauke dan sekitarnya)
        { id: "9304", name: "KABUPATEN ASMAT" },
        { id: "9302", name: "KABUPATEN BOVEN DIGOEL" },
        { id: "9303", name: "KABUPATEN MAPPI" },
        { id: "9301", name: "KABUPATEN MERAUKE" }
    ],
    "94": [ // PAPUA TENGAH (Nabire dan sekitarnya)
        { id: "9407", name: "KABUPATEN DEIYAI" },
        { id: "9405", name: "KABUPATEN DOGIYAI" },
        { id: "9406", name: "KABUPATEN INTAN JAYA" },
        { id: "9409", name: "KABUPATEN MIMIKA" },
        { id: "9401", name: "KABUPATEN NABIRE" },
        { id: "9403", name: "KABUPATEN PANIAI" },
        { id: "9408", name: "KABUPATEN PUNCAK" },
        { id: "9402", name: "KABUPATEN PUNCAK JAYA" }
    ],
    "95": [ // PAPUA PEGUNUNGAN (Jayawijaya dan sekitarnya)
        { id: "9501", name: "KABUPATEN JAYAWIJAYA" },
        { id: "9507", name: "KABUPATEN LANNY JAYA" },
        { id: "9505", name: "KABUPATEN MAMBERAMO TENGAH" },
        { id: "9508", name: "KABUPATEN NDUGA" },
        { id: "9502", name: "KABUPATEN PEGUNUNGAN BINTANG" },
        { id: "9504", name: "KABUPATEN TOLIKARA" },
        { id: "9503", name: "KABUPATEN YAHUKIMO" },
        { id: "9506", name: "KABUPATEN YALIMO" }
    ],
    "96": [ // PAPUA BARAT DAYA (Sorong dan sekitarnya)
        { id: "9605", name: "KABUPATEN MAYBRAT" },
        { id: "9603", name: "KABUPATEN RAJA AMPAT" },
        { id: "9602", name: "KABUPATEN SORONG SELATAN" },
        { id: "9601", name: "KABUPATEN SORONG" },
        { id: "9604", name: "KABUPATEN TAMBRAUW" },
 ...
 * @param {string} provinsiId - ID provinsi (e.g., "32" untuk Jawa Barat)
 * @returns {Array} - Array of kota objects, sorted alphabetically
 */
export function getKotaByProvinsiId(provinsiId) {
    if (!provinsiId) return [];
    const kota = kotaByProvinsi[provinsiId] || [];
    return [...kota].sort((a, b) => a.name.localeCompare(b.name));
}

/**
 * Mendapatkan nama provinsi berdasarkan ID
 * @param {string} provinsiId - ID provinsi (e.g., "32")
 * @returns {string} - Nama provinsi (e.g., "JAWA BARAT") atau empty string
 */
export function getProvinsiNameById(provinsiId) {
    if (!provinsiId) return '';
    const prov = provinsiList.find(p => p.id === provinsiId);
    return prov ? prov.name : '';
}

/**
 * Mendapatkan ID provinsi berdasarkan nama
 * @param {string} provinsiName - Nama provinsi
 * @returns {string} - ID provinsi atau empty string
 */
export function getProvinsiIdByName(provinsiName) {
    if (!provinsiName) return '';
    const prov = provinsiList.find(p => p.name.toUpperCase() === provinsiName.toUpperCase());
    return prov ? prov.id : '';
}

/**
 * Validasi apakah provinsi valid
 * @param {string} provinsiName - Nama provinsi
 * @returns {boolean} - true jika provinsi valid
 */
export function isValidProvinsi(provinsiName) {
    if (!provinsiName) return false;
    return provinsiList.some(p => p.name.toUpperCase() === provinsiName.toUpperCase());
}